...
def shuffle_aligned_list(data):
    ...
    list_to_overcome_issue = []
    for d in data:
        #print("d[650] " ,d[148])
       #print("shape" , d[0].shape[0])
        try:
            list_to_overcome_issue.append(d[shuffle_index])
        except:
            ...
            try:
                list_to_overcome_issue.append(d[shuffle_index-1:shuffle_index])
            except:
                print("nope")

                #print(d)
    #return shuffle_index, list_to_overcome_issue
...
def batch_generator(data, batch_size, shuffle=True):
    ...
    while True:
        ...
        batch_count += 1
        yield [d[start:end] for d in data], shuffle_index
